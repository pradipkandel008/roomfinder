                        ...
                        <h3> Roommate needed for {{$singleroommate->first_name}} {{$singleroommate->last_name}}
                            ...
                            <p class="links">
                                ...
                                <span>Occupation:{{$singleroommate->occupation}}<br/>
                                    ...
                                    <a href="{{route('admin.roommate.edit',[$singleroommate->id])}}"><span class="btn btn-success">Edit</span></a>
                                    <a href="{{route('admin.roommate.delete',[$singleroommate->id])}}"><span class="btn btn-danger" onclick="return confirm('Are you sure want to delete this roommate request?')">Delete</span></a>
