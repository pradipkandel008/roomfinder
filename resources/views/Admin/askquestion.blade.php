...
@section('title',"RoomFinder-Admin-Forum-AskQuestions")
     ...
     <div class="col-md-8 col-md-offset-2" style="margin-top: 12px;">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form class="form-horizontal" method="POST" action="{{route('admin.askquestion.submit')}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
