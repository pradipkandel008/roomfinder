        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('owner.account.submit') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                Current image:<img class="img-responsive" src="{{asset('image/uploads/owners/'.$user->image)}}" width="100px">
