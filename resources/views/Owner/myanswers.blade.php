    ...
    <div class="row">
        ...
        <table class="forumtable">
            ...
            <tr>
                ...
                <tr>
                    <td colspan="2">
                        <a href="{{route('owner.editanswer',[$singlequestion->aid])}}"><span class="btn btn-success">Edit</span></a>
                        <a href="{{route('owner.deleteanswer',[$singlequestion->aid])}}"><span class="btn btn-danger" onclick="return confirm('Are you sure want to delete this answer')">Delete</span></a>
                    </td>
                </tr>
