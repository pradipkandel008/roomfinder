...
@section('title',"RoomFinder-Owner-About Us")
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{route('feedback.submit')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group{{ $errors->has('feedback') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                               <textarea name="feedback" cols="46" rows="5"></textarea>
                        ...
                        <div class="form-group {{ $errors->has('website') ? ' has-error' : '' }}">
                            <label for="website" class="col-md-4 control-label">Website Number</label>
