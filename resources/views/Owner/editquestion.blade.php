...
@section('title',"RoomFinder-Owner-Edit Question")
       ...
       <div class="col-md-8 col-md-offset-2" style="margin-top: 12px;">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form class="form-horizontal" method="POST" action="{{route('owner.updatequestion',$question->id)}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group{{ $errors->has('question') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <textarea name="question" cols="46" rows="5" required>{{$question->question}}</textarea>
