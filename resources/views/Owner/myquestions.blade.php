...
@section('title',"RoomFinder-Owner-Myquestions")
        ...
        @else
            ...
            <tr>
                <td colspan="2">
                    ...
                    <a href="{{route('owner.editquestion',$singlequestion->id)}}"><span class="btn btn-success">Edit</span></a>
                    <a href="{{route('owner.deletequestion',$singlequestion->id)}}"><span class="btn btn-danger"
