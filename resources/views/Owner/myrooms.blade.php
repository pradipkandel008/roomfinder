 ...
 @section('title',"RoomFinder-Owner-Rooms")
           ...
           <figcaption>
            ...
            <p class="links">
              ...
              <span>Water:{{$singleroom->water_facility}}<br/>Parking:{{$singleroom->parking}}<br/>
                ...
                <a href="{{route('owner.room.edit',[$singleroom->id])}}"><span class="btn btn-success">Edit</span></a>
              <a href="{{route('owner.room.delete',[$singleroom->id])}}"><span class="btn btn-danger" onclick="return confirm('Are you sure want to delete this room?')">Delete</span></a>
