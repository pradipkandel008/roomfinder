...
@section('title',"RoomFinder-User-Booked Rooms")
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="text-center">
                <h1 class="btn btn-danger">Oops! You havenot booked any rooms yet</h1>
            </div>
        </div>
        ...
        <div class="col-md-6 col-sm-8">
            <div class="grid" >
                <figure class="effect-ming">
                    ...
                    <figcaption>
                        <h3> You booked {{$singleroom->no_of_rooms}} room  at {{$singleroom->location}} </h3><br/>
                        <p class="links">
                            ...
                            <span>Owner:{{$singleroom->owner_first_name}} {{$singleroom->owner_last_name}}<br/>
                              ...
                              Booked on:{{$singleroom->created_at}}</span><br/>
                              <a class="rlink" href="{{route('user.cancelbookings',[$singleroom->id,$singleroom->rid])}}">
                                <button class="btn btn-danger"
                                onclick="return confirm('Are you sure want to cancel this booking?')">
                            Cancel Booking</button></a>
                        </p>
                    </figcaption>
                </figure>
            </div>
