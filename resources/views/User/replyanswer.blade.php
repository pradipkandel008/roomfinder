...
@section('title',"RoomFinder-User-Reply answer")
...
<div class="container">
    ...
    <div class="row">
        ...
        <form  class="form-horizontal" action="{{route('user.replyanswer.submit',$question->id)}}" method="post">
            {{csrf_field()}}

            <strong>Answer</strong><br/>

            <textarea id="answer" name="answer" rows="5" cols="70" required></textarea><br/><br/>
