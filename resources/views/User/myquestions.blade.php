...
@section('title',"RoomFinder-User-Myquestions")
...
<div class="container">
    <div class="row">
        ...
        @else
            ...
            <tr>
                <td colspan="2">
                    <a href="{{route('user.replyanswer',$singlequestion->id)}}"><span class="btn btn-success">Reply</span></a>
                    <a href="{{route('user.showanswers',$singlequestion->id)}}"><span class="btn btn-info">View all replies</span></a>
                    <a href="{{route('user.editquestion',$singlequestion->id)}}"><span class="btn btn-success">Edit</span></a>
                    <a href="{{route('user.deletequestion',$singlequestion->id)}}"><span class="btn btn-danger"
