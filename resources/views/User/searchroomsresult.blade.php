...
@section('title',"RoomFinder-User-Rooms")
        ...
        <div class="row">
            ...
            @if(count($rooms)==0)
                <div class="col-md-6 col-md-offset-3">
                    <div class="text-center">
                        <h1 class="btn btn-danger">Oops! No room found for your search</h1>
                    </div>
                </div>
            ...
            @else
              ...
              Publish on:{{$singleroom->updated_at}}</span><br/>
                                        <a href="{{route('user.bookroom',[$singleroom->id])}}"><span class="btn btn-success">Book Now</span></a>
                                    </p>
                                </figcaption>
                            </figure>
                        </div>
