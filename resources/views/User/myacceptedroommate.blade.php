...
@section('title',"RoomFinder-User-My accepted Roommates")
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="text-center">
                <h1 class="btn btn-danger">Oops! You havenot accepted any roommate requests yet</h1>
            </div>
        </div>
                        ...
                        <h3> Roommate needed for {{$singleroommate->first_name}} {{$singleroommate->last_name}}
                            ...
                            <p class="links">
                                ...
                                <span>Occupation:{{$singleroommate->occupation}}<br/>
                                    ...
                                    <a href="{{route('user.cancelmyacceptedrequests',[$singleroommate->id,$singleroommate->rid])}}">
                                        <span class="btn btn-danger"
                                        onclick="return confirm('Are you sure want to cancel this accepted roommate request?')">
                                    Cancel This Accept</span></a>
                                </p>
                            </figcaption>
                        </figure>
                    </div>
